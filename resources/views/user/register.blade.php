            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 style="color: blue" class="panel-title">Đăng Ký</h3>
                    </div>
                        ...
                        <form role="form" action="{{route('user-register')}}" method="POST">
                            ...
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="nhập họ tên" name="name" type="text" autofocus>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="nhập email" name="email" type="email" autofocus>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="nhập nhập mật khẩu" name="password" type="password" value="">
                                </div>
                                 <div class="form-group">
                                    <input class="form-control" placeholder="nhập lại mật khẩu" name="psw-repeat" type="password" value="">
                                </div>
                                <button type="submit" class="btn btn-lg btn-success btn-block">Đăng ký</button>
                                <div>Quay lại<a href="{{route('user-login')}}">Đăng Nhập</a></div>
                            </fieldset>
                        </form>
                    </div>
                </div>
